...
public class WuZiQi extends BasicBoard implements IFile,Cloneable{
    ...
    WuZiQi(int gT, int SL, int mRC, int mRCB, int mRCW, int lpx, int lpy, int bN, int wN, boolean pling, boolean BT, boolean wR, boolean BW,ArrayList<ArrayList<Integer>> bd, ArrayList<ArrayList<ArrayList<Integer>>> bdr){
